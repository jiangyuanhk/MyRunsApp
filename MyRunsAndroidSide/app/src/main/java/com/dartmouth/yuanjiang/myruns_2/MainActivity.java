...
import com.dartmouth.yuanjiang.myruns_2.view.SlidingTabLayout;
...
public class MainActivity extends Activity {
     ...
     */
    private String SENDER_ID = "49564357550";
    ...
    private BroadcastReceiver mMessageUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            datasource = EntryDataSource.getInstance(context);
            entry = datasource.getEntryByIndex(id);
